...
const CACHE = 'lobangking-v12';
const CORE = [
  './', 'index.html', 'deals.html', 'about.html', 'submit.html', 'privacy.html', '404.html',
  'css/styles.min.css?v=8', 'js/main.js?v=8', 'js/theme.js?v=8', 'js/vitals.js?v=8', 'js/protect.js?v=8', 'js/engagement.js?v=8', 'js/translate.js?v=8', 'js/consent.js?v=8', 'js/a11y.js?v=8',

...
const CACHE = 'lobangking-v10';
const CORE = [
  './', 'index.html', 'deals.html', 'about.html', 'submit.html', 'privacy.html', '404.html',
  'css/styles.min.css?v=6', 'js/main.js?v=6', 'js/theme.js?v=6', 'js/vitals.js?v=6', 'js/protect.js?v=6', 'js/engagement.js?v=6', 'js/translate.js?v=6', 'js/consent.js?v=6', 'js/a11y.js?v=6',
